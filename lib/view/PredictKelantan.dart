...
class Chart2Pages extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => Chart2PagesState();
}

class Chart2PagesState extends State<Chart2Pages> {
  ...
  Future<List<WeatherPredict>> getData() async {
    try {
      ...
      var response = await Dio().get(
          "http://13.228.175.39:89/justmarry/api/check_kb?startDate=" +
              startDateCtrl.text +
              "&endDate=" +
              endDateCtrl.text);
