...
class Chart4Pages extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => Chart4PagesState();
}

class Chart4PagesState extends State<Chart4Pages> {
  ...
  Future<List<WeatherPredict>> getData() async {
    try {
      ...
      var response = await Dio().get(
          "http://13.228.175.39:89/justmarry/api/check_pinang?startDate=" +
              startDateCtrl.text +
              "&endDate=" +
              endDateCtrl.text);
