...
class _SignUpPageState extends State<SignUpPage> {
                          ...
                          Column(
                            children: <Widget>[
                              ...
                              Text(
                                ...
                                style: TextStyle(
                                    fontSize: 15, color: Colors.amber[700]),
                              ),
                            ],
                          ),
                          Padding(
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: MaterialButton(
                          ...
                          height: 60,
                          onPressed: () {
                            signUp(fController.text, lController.text,
  ...
  signUp(String fName, String lName, String email, String password) async {
    ...
    print("firstName : " + fController.text);

    var formData = { 'firstName': fController.text ,
        'lastName': lController.text,
        'email' : emailController.text ,
        'password' :  passController.text };

    print(formData);
    // "http://13.228.175.39:89/justmarry/api/create_account?firstName=raf&lastName=ra&email=raf@gmail.com", data: formData);
    String urlCall = "http://13.228.175.39:89/justmarry/api/create_account?firstName=" + fName +  "&lastName="+ lName +"&email="+email+"&password="+password;
    try {
      var response = await dio.post(
        // "http://13.228.175.39:89/justmarry/api/create_account?firstName=raf&lastName=ra&email=raf@gmail.com", data: formData);
        // "http://13.228.175.39:89/justmarry/api/create_account?firstName" + fName +  "&lastName="+ lName +"&email="+email+"&password"+password,  data: formData);
          urlCall );
      ...
      if (response.statusCode == 200) {
        // setState(() {
          // _user = User.fromJson(json.decode(response.data));
          print("inside IF");
          ...
          // Data.sharedPref.setString("firstName",fName);
          // Data.sharedPref.setString("lastName", lName);
          // Data.sharedPref.setString("email", email);
          // Data.sharedPref.setString("password", password);
          // Get.toNamed('login');
        // });
